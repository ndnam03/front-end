  ...
  <div class="sticky top-0 z-40">
    ...
    >
      ...
      <div class="flex">
        ...
        <!-- search bar -->
        <div class="relative text-gray-600 justify-center ml-40">
          <input
            type="search"
            name="serch"
            placeholder="Search products..."
            class="bg-white h-10 w-full float-right justify-center ml-20 xl:w-64 px-5 rounded-lg border text-sm focus:outline-none"
          />
    ...
    <!-- dropdown menu -->
    <div
      class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 bottom-120 right-0"
